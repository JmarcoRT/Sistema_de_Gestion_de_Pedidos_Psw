...
inline void cuadro(int x1, int y1, int x2, int y2) {
    for (int i = x1; i < x2; i++) {
...
inline void imprimirMenu(const char *titulo, const char *opciones[], int m, int opcionSeleccionada) {
    cuadro(0, 0, 119, 29);
    cuadro(8, 1, 110, 3);
...
inline int menus(const char *titulo, const char *opciones[], int m) {
